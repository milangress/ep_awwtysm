...
var loop = /*@__PURE__*/getDefaultExportFromCjs$1(rafLoop);
...
function createChromaFilterBank(numFilters, sampleRate, bufferSize, centerOctave, octaveWidth, baseC, A440) {
    ...
    if (baseC) {
        weights = __spreadArray(__spreadArray([], weights.slice(3), true), weights.slice(0, 3));
    }
...
var Meyda$1 = /*@__PURE__*/getDefaultExportFromCjs$1(main);
  ...
  constructor ({
    ...
    window.navigator.mediaDevices.getUserMedia({video: false, audio: true})
      ...
      //  console.log(this.context)
        this.meyda = Meyda$1.createMeydaAnalyzer({
...
var regl = /*@__PURE__*/getDefaultExportFromCjs$1(reglExports);
...
let defaultHydraInstance = new HydraRenderer({ 
    ...
    precision: 'highp',  // force precision of shaders, can be 'highp', 'mediump', or 'lowp' (recommended for ios). When no precision is specified, will use highp for ios, and mediump for everything else.
...
function Aww(next, hydraInstance) {
  // Core structures
  var context = {
...
exports.Aww = Aww;
exports.defaultHydraInstance = defaultHydraInstance;
exports.hydra = hydra;
